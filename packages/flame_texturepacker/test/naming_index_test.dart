...
void main() {
  ...
  group('Index Pattern Parsing', () {
    ...
    Future<Iterable<Region>> createAndLoadRegions(String content) async {
      ...
      final realPngBytes = await File('test/assets/whitelist/whitelist_test.png').readAsBytes();
      await imageFile.writeAsBytes(realPngBytes);

      final atlasData = await TexturePackerAtlas.loadAtlas(atlasFile.path, fromStorage: true);
